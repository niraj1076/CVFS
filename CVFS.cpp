...
UFDT UFDTArr[50];       //array of ufdt(user file discriptor table)
...
void man(char *name)
{
    ...
    {
        printf("Descrition : Used to create new regular file \n");
        printf("Usage : create File_name permission \n");
    }
    else if(strcmp(name,"read") == 0)
    {
        printf("Descrition : Used to read data from regular file \n");
        printf("Usage : read File_name No_Of_Bytes_To_Read \n");
    }
    else if(strcmp(name,"write") == 0)
    {
        printf("Descrition : Used to write into regular file \n");
        printf("Usage : write File_name\n After this enter that we want to write \n");
    }
    else if(strcmp(name,"ls") == 0)
    {
        printf("Descrition : Used to list all information file \n");
        printf("Usage :ls\n");
    }
    else if(strcmp(name,"stat") == 0)
    {
        printf("Descrition : Used to display information of file \n");
    ...
    {
        printf("Descrition : Used to remove data of file \n");
        printf("Usage : truncate File_name\n");
    }
    else if(strcmp(name,"open") == 0)
    {
        printf("Descrition : Used to open existing file \n");
        printf("Usage : open File_name mode\n");
    }
    else if(strcmp(name,"close") == 0)
    {
        printf("Descrition : Used to close opened file \n");
        printf("Usage : close File_name\n");
    }
    else if(strcmp(name,"closeall") == 0)
    {
        printf("Descrition : Used to close all opened file \n");
        printf("Usage : closeall\n");
    }
    else if(strcmp(name,"lseek") == 0)
    {
        printf("Descrition : Used to change the file offset\n");
...
void DisplayHelp()
{
    ...
    printf("fstat : To Display information od file using file descriptor\n");
...
int WriteFile(int fd, char *arr, int isize)
{
    ...
    if((UFDTArr[fd].ptrfiletable -> ptrinode -> FileSize) != REGULAR)       return -3;
...
int fstat_file(int fd)
{
    ...
    if(temp -> permission == 1)
        ...
        printf("File permission : Read & write both\n");
    printf("----------------------------------------------------------\n\n");
...
int main()
{
    ...
    while(1)
    {
        ...
        { 
            ...
            {
                printf("Terminatimg the Marvellous Virtual File System\n");
                break;
            }
            else
            {
        ...
        else if(count == 3)
        {
            if(strcmp(command[0], "create") == 0)
            {
                ...
                if(ret >= 0)
                    printf("Error : File is successfully Created with the descriptor : %d\n", ret);
                if(ret == -1)
                    printf("ERROR : Incorrect parameter \n");
                if(ret == -2)
            ...
            else if(strcmp(command[0], "open") == 0)
            {
                ...
                if(ret >= 0)
                    printf("Error : File is successfully Opened with the descriptor : %d\n", ret);
                if(ret == -1)
                    printf("ERROR : Incorrect parameter \n");
                if(ret == -2)
            ...
            else if (strcmp(command[0], "read") == 0)
            {
                ...
                if(fd == -1)
                {
                    printf("Error : Incorrect Paremater \n");
                    continue;
                }
        ...
        else if(count == 4)
        {
            if(strcmp(command[0], "lseek") == 0)
            {
                ...
                if(ret == -1)
                {
                    printf("ERROR : Unable to perfoem lseek\n");
                }
            }
            else
            {
